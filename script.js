...
"Square thing.png", ["https://editor.p5js.org/jocelyna2551/full/NNpEcqFIu"]),
...
"Blackjack.png",["Original:","https://github.com/Jocowl25/Blackjack","Javascript Port:","https://codepen.io/Jocowl/full/MWdypYJ"]),
...
"Based on an internet trend from the 2010s, this recreates the <a class='link' target='_blank' href='https://m.youtube.com/watch?v=FtutLA63Cp8'>Bad Apple Youtube video</a> out of the user's letters of choice. I used a separate program to create data for each frame of the video, which is stored in this program to recreate the frames with characters. I recommend inputing emojis-it looks very cool.<br> Made with HTML, CSS, and p5.js.",
...
new project("2024","Number Syllable Counter",
"The combination of a random idea I had one day and the desire to learn Python led to the creation of this project. The program counts how many syllables it takes to say a number out loud; for example, 7 is two syllables, and 345 is six syllables. It can also make a graph of how the syllables change over time. My favorite part is, due to the rules of how numbers are pronounced, the program can accept numbers up to undecillion—that's 36 zeros! <br> Made with Python.",
"NumGraph.png",["https://github.com/Jocowl25/Number-Syllable-Counter"])
];
